...
module.exports = { session: process.env.SESSION_ID || 'keith',
    ...
    GITHUB : process.env.GITHUB|| 'https://github.com/Marksimiyu/DESTINY-V1',
    OWNER_NAME : process.env.OWNER_NAME || "254110550356",
    ...
    CAPTION : process.env.CAPTION || "DESTINY V-1",
    BOT : process.env.BOT_NAME || 'DESTINY V1',
